...
namespace Week09Homework
{
    public partial class FormManager : Form
    {
        ...
        public FormManager()
        {
            ...
            //[숙제] cmbYear처럼 항목을 반복문을 통해서 추가하도록 변경해볼 것.
            foreach (var Reg_status in Enum.GetValues(typeof(REG_STATUS)))
            {
                cmbRegStatus.Items.Add(Reg_status);
            }
            ...
            var student = new Student("20240001", "김미영")
            {
            ...
            student.SetBirthInfo(2004, 01, 01);

            students.Add("20240001", student);


            foreach (var student1 in students) {
                if (student1.Value != null) {
                    lbxDictionary.Items.Add(student1.Value);
                }
            }
        }
        ...
        private void RegisterStudent()
        {
            ...
            student.RegStatus = (REG_STATUS)cmbRegStatus.SelectedItem;
        ...
        private void UpdateStudent() //define
        {
            ...
            selectedStudent.RegStatus = (REG_STATUS)cmbRegStatus.SelectedItem;
        ...
        private void DisplaySelectedStudent(Student student)
        {
            ...
            for (int i = 0; i < cmbRegStatus.Items.Count; i++) {
                if ((REG_STATUS)cmbRegStatus.Items[i] == student.RegStatus)
                {
